...
CREATE TABLE `thoikhoabieu` (
  ...
  `maLopHP` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`maTKB`),
  KEY `FKo4u6d7istwj8vvlakmbejemsx` (`maLopHP`),
  CONSTRAINT `FKo4u6d7istwj8vvlakmbejemsx` FOREIGN KEY (`maLopHP`) REFERENCES `lophocphan` (`maLopHP`)
