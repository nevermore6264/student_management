...
CREATE TABLE `lichsudangky` (
  ...
  `ngayGioDangKy` datetime(6) DEFAULT NULL,
  `trangThai` bit(1) DEFAULT NULL,
  `maLopHP` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `maSinhVien` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`maLichSu`,`maLopHP`,`maSinhVien`),
  KEY `FKavdl7c3s9drgc06t1rcs9mnhr` (`maLopHP`),
  KEY `FKhwhya46naupl3dy86mxvdkl4j` (`maSinhVien`),
  CONSTRAINT `FKavdl7c3s9drgc06t1rcs9mnhr` FOREIGN KEY (`maLopHP`) REFERENCES `lophocphan` (`maLopHP`),
  CONSTRAINT `FKhwhya46naupl3dy86mxvdkl4j` FOREIGN KEY (`maSinhVien`) REFERENCES `sinhvien` (`maSinhVien`)
