...
CREATE TABLE `sinhvien` (
  ...
  `hoTenSinhVien` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  KEY `FK3vmf5bekbtgbf5ydc1xwfm2m4` (`maLop`),
  CONSTRAINT `FK3vmf5bekbtgbf5ydc1xwfm2m4` FOREIGN KEY (`maLop`) REFERENCES `lop` (`maLop`)
